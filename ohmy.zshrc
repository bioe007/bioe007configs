...
# gives some cool completions like ^gh
# {{{
...
# }}}
source ~/bin/fzf-git/fzf-git.sh

# To see all bat themes -
# bat --list-themes | fzf --preview="bat --theme={} --color=always go/src/github.com/bioe007/design_patterns_in_go/builder.go"
